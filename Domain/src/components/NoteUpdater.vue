<template>
    <div class="note-grid">
        <div class="note-editor" :style="{'background-color': theme, 'font-family': font}">
            <input class="title-input" type="text" v-model="title" placeholder="수정하기">
            ...
            <div class="note-editor-info">
                ...
                <input class="user-input" v-model="user" placeholder="글쓴이">      
            </div>
            ...
            <div class="note-editor-bottom">
                <button @click=noteUpdate class="fas fas-check-circle"><i class="fas fa-check-circle"></i></button>
            </div>
        </div>
    </div>
</template>
...
export default {
    ...
    data: function() {
        return {
            ...
            font:this.note.font,
            hashtag:this.note.hashtag.toString(),
    ...
    methods: {   
        ...
        noteUpdate() {
            ...
            this.$emit('noteUpdate', this.idx, this.title, this.user, this.text, this.theme, this.font, tag, this.image);
            this.$emit('close');
        },
        settheme(theme){
            this.theme = theme;
